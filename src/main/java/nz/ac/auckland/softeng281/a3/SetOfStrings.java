...
public class SetOfStrings {
	...
	public SetOfStrings union(SetOfStrings other) {
		...
		//Create output string for return
		SetOfStrings output = new SetOfStrings();
		
		//Iterate through each element in this set
		for (String element: this.elements) {
			output.insertElement(element);
		}
		
		//Iterate through each element in other set
	...
	public SetOfStrings intersection(SetOfStrings other) {
		...
		//If the elements are equal in both sets, insert that element in output
		for (String thisElement: this.elements) {
			for (String otherElement: other.elements) {
				if (thisElement == otherElement) {
					output.insertElement(thisElement);
				}
			}
		}
	...
	public SetOfStrings difference(SetOfStrings other) {
		...
		//Let output first equal all elements in this set
		//Iterate through each element in this set
		for (String element: this.elements) {
			output.insertElement(element);
		}			
		...
		//Iterate through nested for loop
		//If the elements are equal in both sets, delete that element in output
		for (String thisElement: this.elements) {
			for (String otherElement: other.elements) {
				if (thisElement == otherElement) {
					output.deleteElement(thisElement);
				}
			}
		}
